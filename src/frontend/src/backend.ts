...
export class Backend implements backendInterface {
    ...
    async buy(arg0: Instrument, arg1: Amount): Promise<Balance> {
        if (this.processError) {
            try {
    ...
    async deposit(arg0: Balance): Promise<Balance> {
        if (this.processError) {
            try {
    ...
    async getAllCurrentAssetPrices(): Promise<Array<Asset>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCurrentAssetPrices();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerBalance(): Promise<Balance> {
        if (this.processError) {
            try {
    ...
    async getCallersInvestmentPortfolio(): Promise<Array<[Instrument, Amount]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallersInvestmentPortfolio();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPrice(arg0: string): Promise<Price> {
        if (this.processError) {
            try {
    ...
    async getTradeHistory(): Promise<Array<Trade>> {
        if (this.processError) {
            try {
    ...
    async sell(arg0: Instrument, arg1: Amount): Promise<Balance> {
        if (this.processError) {
            try {
